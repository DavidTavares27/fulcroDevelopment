...
if((!((ident == null)))){
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((function (){var G__47917 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(query,cljs.core.first(ident));
var G__47918 = data__$1;
var G__47919 = refs;
var G__47920 = union_seen;
var G__47921 = transform;
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(G__47917,G__47918,G__47919,G__47920,G__47921) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,G__47917,G__47918,G__47919,G__47920,G__47921));
...
var vec__47933 = com.fulcrologic.fulcro.algorithms.do_not_use.join_entry(expr);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47933,(0),null);
var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47933,(1),null);
...
var G__47948 = cljs.core.next(q);
var G__47949 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,i);
q = G__47948;
ret = G__47949;
continue;
} else {
var G__47950 = cljs.core.next(q);
var G__47951 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,x);
q = G__47950;
ret = G__47951;
continue;
}
...
var xs = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,vec__47933,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (p1__47915_SHARP_){
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(sel__$1,p1__47915_SHARP_,refs,union_entry,transform) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,sel__$1,p1__47915_SHARP_,refs,union_entry,transform));
});})(q,ret,vec__47933,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
),v);
if((!((((class$ == null)) || ((!(com.fulcrologic.fulcro.components.has_ident_QMARK_(class$)))))))){
var is = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,xs,vec__47933,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (p1__47916_SHARP_){
return (com.fulcrologic.fulcro.components.get_ident.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,p1__47916_SHARP_) : com.fulcrologic.fulcro.components.get_ident.call(null,class$,p1__47916_SHARP_));
});})(q,ret,xs,vec__47933,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
),xs);
if(cljs.core.vector_QMARK_(sel__$1)){
if(cljs.core.empty_QMARK_(is)){
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(refs,((function (q,ret,is,xs,vec__47933,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (refs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__47933,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (m,p__47936){
var vec__47937 = p__47936;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47937,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47937,(1),null);
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(m,i,cljs.core.merge,x);
});})(q,ret,is,xs,vec__47933,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__47933,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (ret__$1,p__47940){
var vec__47941 = p__47940;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47941,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47941,(1),null);
...
var G__47952 = cljs.core.next(q);
var G__47953 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,is);
q = G__47952;
ret = G__47953;
continue;
} else {
var G__47954 = cljs.core.next(q);
var G__47955 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,xs);
q = G__47954;
ret = G__47955;
continue;
}
...
if((v == null)){
var G__47956 = cljs.core.next(q);
var G__47957 = ret;
q = G__47956;
ret = G__47957;
continue;
} else {
var G__47958 = cljs.core.next(q);
var G__47959 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__47958;
ret = G__47959;
continue;
...
var v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(data__$1,k);
if((v == null)){
var G__47960 = cljs.core.next(q);
var G__47961 = ret;
q = G__47960;
ret = G__47961;
continue;
} else {
var G__47962 = cljs.core.next(q);
var G__47963 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__47962;
ret = G__47963;
continue;
}
