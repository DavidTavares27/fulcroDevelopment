...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__35288){
var vec__35289 = p__35288;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35289,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35289,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__35292){
...
var vec__35296 = temp__5751__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35296,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35296,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__35299 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35299,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__35299;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__35304){
var map__35305 = p__35304;
var map__35305__$1 = cljs.core.__destructure_map(map__35305);
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35305__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__35307){
var map__35308 = p__35307;
var map__35308__$1 = cljs.core.__destructure_map(map__35308);
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35308__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__35309 = cljs.core.first(rem);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__35306_SHARP_){
var G__35312 = p1__35306_SHARP_;
var G__35313 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__35312,G__35313) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__35312,G__35313));
}));
} else {
