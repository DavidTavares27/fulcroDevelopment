...
var vec__43683 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43683,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43683,(1),null);
...
var expr__$1 = (function (){var G__43687 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__43687);
} else {
return G__43687;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__43690 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__43690) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__43690));
} else {
return expr;
...
var len__5766__auto___43748 = arguments.length;
var i__5767__auto___43749 = (0);
while(true){
if((i__5767__auto___43749 < len__5766__auto___43748)){
args__5772__auto__.push((arguments[i__5767__auto___43749]));

var G__43751 = (i__5767__auto___43749 + (1));
i__5767__auto___43749 = G__43751;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq43699){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq43699));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__43725 = query;
var G__43725__$1 = (((G__43725 == null))?null:cljs.core.meta(G__43725));
var G__43725__$2 = (((G__43725__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__43725__$1));
if((G__43725__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__43725__$2) : component_name_fn.call(null,G__43725__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,1736601867,null);
} else {
}
