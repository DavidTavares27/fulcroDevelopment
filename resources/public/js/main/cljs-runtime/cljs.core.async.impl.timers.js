...
var i_37648 = (0);
while(true){
if((i_37648 < arr.length)){
(arr[i_37648] = null);

var G__37649 = (i_37648 + (1));
i_37648 = G__37649;
continue;
} else {
}
...
var i_37656 = (self__.level + (1));
while(true){
if((i_37656 <= (new_level + (1)))){
(update[i_37656] = self__.header);

var G__37657 = (i_37656 + (1));
i_37656 = G__37657;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_37658 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_37658[i]));
} else {
x__$2.forward.push((((i < links_37658.length))?(links_37658[i]):null));
}

if((i < links_37658.length)){
(links_37658[i] = x__$2);
} else {
links_37658.push(x__$2);
}
...
var i_37660 = (0);
while(true){
if((i_37660 <= self__.level)){
var links_37661 = (update[i_37660]).forward;
if((x__$1 === (((i_37660 < links_37661.length))?(links_37661[i_37660]):null))){
(links_37661[i_37660] = (x__$1.forward[i_37660]));

var G__37662 = (i_37660 + (1));
i_37660 = G__37662;
continue;
} else {
var G__37663 = (i_37660 + (1));
i_37660 = G__37663;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__37670 = nx;
var G__37671 = (level__$1 - (1));
x = G__37670;
level__$1 = G__37671;
continue;
} else {
var G__37672 = x;
var G__37673 = (level__$1 - (1));
x = G__37672;
level__$1 = G__37673;
continue;
}
