...
var G__45359 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__45359,"id",id);

goog.dom.appendChild(document.body,G__45359);
...
var G__45360 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__45360,"id",id);

goog.dom.appendChild(document.body,G__45360);
...
var temp__5751__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__45361_SHARP_){
return ((clojure.string.starts_with_QMARK_(p1__45361_SHARP_,"__reactInternalInstance$")) || (clojure.string.starts_with_QMARK_(p1__45361_SHARP_,"__reactFiber$")));
...
com.fulcrologic.fulcro.inspect.element_picker.pick_element = (function com$fulcrologic$fulcro$inspect$element_picker$pick_element(p__45362){
var map__45363 = p__45362;
var map__45363__$1 = cljs.core.__destructure_map(map__45363);
var on_pick = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45363__$1,new cljs.core.Keyword(null,"on-pick","on-pick",-1995648316),cljs.core.identity);
...
var instance = (function (){var G__45364 = target__$1;
if((G__45364 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__45364);
}
})();
...
var G__45373 = goog.dom.getParentElement(target__$1);
target__$1 = G__45373;
continue;
}
} else {
...
var G__45365_45374 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__45365_45374) : on_pick.call(null,G__45365_45374));
...
var state_map = (function (){var G__45366 = com.fulcrologic.fulcro.components.any__GT_app(comp);
var G__45366__$1 = (((G__45366 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366).cljs$core$IFn$_invoke$arity$1(G__45366));
if((G__45366__$1 == null)){
return null;
} else {
return cljs.core.deref(G__45366__$1);
}
})();
...
}catch (e45367){var _ = e45367;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__45369 = comp;
var G__45369__$1 = (((G__45369 == null))?null:com.fulcrologic.fulcro.components.react_type(G__45369));
if((G__45369__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__45369__$1);
}
}catch (e45368){var _ = e45368;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__45371 = comp;
var G__45371__$1 = (((G__45371 == null))?null:com.fulcrologic.fulcro.components.react_type(G__45371));
if((G__45371__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__45371__$1,state_map);
}
}catch (e45370){var _ = e45370;
return null;
}})()], null);
});
/**
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45372__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
