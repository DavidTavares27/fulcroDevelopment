...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__27808){
var vec__27809 = p__27808;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27809,(0),null);
...
var vec__27812 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27812,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27812,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27812,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_27880 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_27880(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_27887 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_27887(a,b);
}
});
...
var fexpr__27861 = (function (){var G__27862 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27862__$1)].join('')));

}
})();
return (fexpr__27861.cljs$core$IFn$_invoke$arity$2 ? fexpr__27861.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__27861.call(null,a,b));
}));
/**
