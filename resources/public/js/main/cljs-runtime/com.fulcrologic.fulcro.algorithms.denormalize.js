 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__43692){
var vec__43694 = p__43692;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43694,(0),null);
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__43701){
var vec__43702 = p__43701;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43702,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43702,(1),null);
var ref = vec__43702;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__43708){
var map__43709 = p__43708;
var map__43709__$1 = cljs.core.__destructure_map(map__43709);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43709__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__43741,entity,state_map,parent_node,idents_seen){
var map__43743 = p__43741;
var map__43743__$1 = cljs.core.__destructure_map(map__43743);
var join_node = map__43743__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43743__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43743__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__43773,entity,state_map,idents_seen){
var map__43774 = p__43773;
var map__43774__$1 = cljs.core.__destructure_map(map__43774);
var join_node = map__43774__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43774__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__43779){
var map__43780 = p__43779;
var map__43780__$1 = cljs.core.__destructure_map(map__43780);
var node = map__43780__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43780__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__43781 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43781,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var e = temp__5751__auto__;
var temp__5751__auto____$1 = (function (){var G__43784 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__43784) : union_key__GT_query.call(null,G__43784));
})();
if(cljs.core.truth_(temp__5751__auto____$1)){
var target_ast_node = temp__5751__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__43791,current_entity,state_map,idents_seen){
var map__43792 = p__43791;
var map__43792__$1 = cljs.core.__destructure_map(map__43792);
var top_node = map__43792__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43792__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43792__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__43795 = nil_nodes;
var G__43795__$1 = (((G__43795 == null))?null:cljs.core.first(G__43795));
if((G__43795__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__43795__$1);
}
})());
} else {
return and__5041__auto__;
...
var G__43797 = result_node__$1;
var G__43797__$1 = (((G__43797 == null))?null:cljs.core.persistent_BANG_(G__43797));
if((G__43797__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__43797__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__43799 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__43799 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__43799,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__43801 = props;
var G__43801__$1 = (((G__43801 == null))?null:cljs.core.meta(G__43801));
if((G__43801__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__43801__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__43803 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__43804 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__43804);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__43803);
}});
/**
...
var map__43807 = cljs.core.meta(prior_props);
var map__43807__$1 = cljs.core.__destructure_map(map__43807);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43807__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43807__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
