...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_32353 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_32353(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_32357 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_32357(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_32358 = (function (reader,ch){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_32358(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_32362 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_32362(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_32363 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_32363(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_32364 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_32364(reader);
}
});
...
var G__32414 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__32415 = s.append(c);
c = G__32414;
s = G__32415;
continue;
}
