...
var len__5766__auto___30959 = arguments.length;
var i__5767__auto___30960 = (0);
while(true){
if((i__5767__auto___30960 < len__5766__auto___30959)){
args__5772__auto__.push((arguments[i__5767__auto___30960]));

var G__30961 = (i__5767__auto___30960 + (1));
i__5767__auto___30960 = G__30961;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__30810_30962 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__30811_30963 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__30812_30964 = true;
var _STAR_print_fn_STAR__temp_val__30813_30965 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__30812_30964);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__30813_30965);

try{var _STAR_print_level_STAR__orig_val__30822_30966 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30823_30967 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30823_30967);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30822_30966);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__30811_30963);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__30810_30962);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq30807){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq30807));
}));
...
var new_formatters = current_formatters.filter((function (p1__30867_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__30867_SHARP_)));
}));
...
var G__30873_31029 = f;
var target__28305__auto___31030 = G__30873_31029;
if(cljs.core.truth_(target__28305__auto___31030)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30873_31029)].join(''),"\n","target__28305__auto__"].join('')));
}

(target__28305__auto___31030["toString"] = (function (){
...
var G__30877_31031 = "%c%s";
var G__30878_31032 = "color:transparent";
var G__30879_31033 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__30877_31031,G__30878_31032,G__30879_31033) : f.call(null,G__30877_31031,G__30878_31032,G__30879_31033));
...
var args__5772__auto__ = [];
var len__5766__auto___31039 = arguments.length;
var i__5767__auto___31040 = (0);
while(true){
if((i__5767__auto___31040 < len__5766__auto___31039)){
args__5772__auto__.push((arguments[i__5767__auto___31040]));

var G__31043 = (i__5767__auto___31040 + (1));
i__5767__auto___31040 = G__31043;
continue;
} else {
}
break;
...
var vec__30887 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30887,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30887,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__31046__delegate = function (add_fmt,add_args){
...
var G__31046 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__31049__i = 0, G__31049__a = new Array(arguments.length -  1);
while (G__31049__i < G__31049__a.length) {G__31049__a[G__31049__i] = arguments[G__31049__i + 1]; ++G__31049__i;}
  add_args = new cljs.core.IndexedSeq(G__31049__a,0,null);
} 
return G__31046__delegate.call(this,add_fmt,add_args);};
G__31046.cljs$lang$maxFixedArity = 1;
G__31046.cljs$lang$applyTo = (function (arglist__31051){
var add_fmt = cljs.core.first(arglist__31051);
var add_args = cljs.core.rest(arglist__31051);
return G__31046__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq30881){
var G__30883 = cljs.core.first(seq30881);
var seq30881__$1 = cljs.core.next(seq30881);
var G__30884 = cljs.core.first(seq30881__$1);
var seq30881__$2 = cljs.core.next(seq30881__$1);
var G__30885 = cljs.core.first(seq30881__$2);
var seq30881__$3 = cljs.core.next(seq30881__$2);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30883,G__30884,G__30885,seq30881__$3);
}));
...
var seq__30891 = cljs.core.seq(features);
var chunk__30892 = null;
var count__30893 = (0);
var i__30894 = (0);
while(true){
if((i__30894 < count__30893)){
var feature = chunk__30892.cljs$core$IIndexed$_nth$arity$2(null,i__30894);
...
var G__31056 = seq__30891;
var G__31057 = chunk__30892;
var G__31058 = count__30893;
var G__31059 = (i__30894 + (1));
seq__30891 = G__31056;
chunk__30892 = G__31057;
count__30893 = G__31058;
i__30894 = G__31059;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__30891);
if(temp__5753__auto__){
var seq__30891__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__30891__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__30891__$1);
var G__31060 = cljs.core.chunk_rest(seq__30891__$1);
var G__31061 = c__5565__auto__;
var G__31062 = cljs.core.count(c__5565__auto__);
var G__31063 = (0);
seq__30891 = G__31060;
chunk__30892 = G__31061;
count__30893 = G__31062;
i__30894 = G__31063;
continue;
} else {
var feature = cljs.core.first(seq__30891__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__31064 = cljs.core.next(seq__30891__$1);
var G__31065 = null;
var G__31066 = (0);
var G__31067 = (0);
seq__30891 = G__31064;
chunk__30892 = G__31065;
count__30893 = G__31066;
i__30894 = G__31067;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o30934 = temp__5751__auto__;
return (o30934["version"]);
} else {
return null;
}
})() == null);
