...
var G__29600 = devtools.prefs.pref(v);
v = G__29600;
continue;
} else {
return v;
...
}catch (e29523){var _e__28324__auto__ = e29523;
return false;
}})();
...
}catch (e29533){var _e__28324__auto__ = e29533;
return false;
}})();
...
}catch (e29538){var _e__28324__auto__ = e29538;
return false;
}}
}
});
...
var vec__29558 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29558,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29558,(1),null);
...
return cljs.core.some((function (p1__29569_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29569_SHARP_);
}),template);
});
